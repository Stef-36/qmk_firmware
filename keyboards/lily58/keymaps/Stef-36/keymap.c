...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
         ...
         * |--------------+--------------+--------------+--------------+----------------------+--------------|                                   |--------------+----------------------+--------------+--------------+--------------+--------------|
         * |*/,KC_TAB   /*|*/,KC_Q     /*|*/,KC_W     /*|*/,KC_E     /*|*/,LT(_ACCENT, KC_R)/*|*/,KC_T     /*|                                   |*/,KC_Y     /*|*/,LT(_ACCENT, KC_U)/*|*/,KC_I     /*|*/,KC_O     /*|*/,KC_P     /*|*/,KC_MINS  /*|
         * |--------------+--------------+--------------+--------------+----------------------+--------------|                                   |--------------+----------------------+--------------+--------------+--------------+--------------|
         * |*/,KC_LSFT  /*|*/,KC_A     /*|*/,KC_S     /*|*/,KC_D     /*|*/,KC_F             /*|*/,KC_G     /*|---------------.    ,--------------|*/,KC_H     /*|*/,KC_J             /*|*/,KC_K     /*|*/,KC_L     /*|*/,KC_SCLN  /*|*/,KC_QUOT  /*|
         * |--------------+--------------+--------------+--------------+----------------------+--------------|               |    |              |--------------+----------------------+--------------+--------------+--------------+--------------|
         * |*/,KC_LALT  /*|*/,KC_Z     /*|*/,KC_X     /*|*/,KC_C     /*|*/,KC_V             /*|*/,KC_B     /*|*/,OSL(_SYMB)/*|    |*/,TO(_SYMB)/*|*/,KC_N     /*|*/,KC_M             /*|*/,KC_COMM  /*|*/,KC_DOT   /*|*/,KC_SLSH  /*|*/,KC_RCTL  /*|
         * `-------------------------------------------------------------------------------------------------/-------------- /     \-------------\-------------------------------------------------------------------------------------------------'
         *                                                 |*/,TO(_QWERTY)/*|*/,KC_LGUI  /*|*/,KC_LCTL  /*| /*/,KC_SPC    /*/       \*/,KC_RSFT /*\*/,LT(_MOVE, KC_ENT) /*|*/,KC_BSPC  /*|*/,KC_DEL   /*|
         *                                                 `---------------------------------------------------------------'         `------------------------------------------------------------------'
         */
    ),
    [_MOVE] = LAYOUT(
         ...
         * |--------------+--------------+--------------+--------------+----------------------+--------------|                                   |--------------+----------------------+--------------+--------------+--------------+----------------|
         * |*/,_______  /*|*/,KC_BTN2  /*|*/,KC_WH_L  /*|*/,KC_MS_U  /*|*/,KC_WH_R          /*|*/,KC_WH_U  /*|                                   |*/,KC_PGUP  /*|*/,KC_HOME          /*|*/,KC_UP    /*|*/,KC_END   /*|*/,KC_LBRC  /*|*/,KC_RBRC    /*|
         * |--------------+--------------+--------------+--------------+----------------------+--------------|                                   |--------------+----------------------+--------------+--------------+--------------+----------------|
         * |*/,_______  /*|*/,KC_BTN3  /*|*/,KC_MS_L  /*|*/,KC_MS_D  /*|*/,KC_MS_R          /*|*/,KC_WH_D  /*|---------------.    ,--------------|*/,KC_PGDN  /*|*/,KC_LEFT          /*|*/,KC_DOWN  /*|*/,KC_RGHT  /*|*/,KC_EQL   /*|*/,TO(_CANARY)/*|
         * |--------------+--------------+--------------+--------------+----------------------+--------------|               |    |              |--------------+----------------------+--------------+--------------+--------------+----------------|
    ...
    [_SYMB] = LAYOUT(
         ...
         * `-------------------------------------------------------------------------------------------------/---------------/     \--------------\-------------------------------------------------------------------------------------------------'
         *                                                 |*/,TO(_QWERTY)/*|*/,KC_LALT  /*|*/,_______  /*| /*/,_______   /*/       \*/,_______ /*\*/,LT(_MOVE, KC_ENT) /*|*/,_______  /*|*/,_______  /*|
         *                                                 `---------------------------------------------------------------'         `------------------------------------------------------------------'
         */
    ),
    [_ACCENT] = LAYOUT(
        /* ACCENT
         * ,-------------------------------------------------------------------------------------------------.                                   ,---------------------------------------------------------------------------------------------------.
         * |*/_______   /*|*/,KX_ORDN  /*|*/,_______  /*|*/,KX_EURO  /*|*/,_______          /*|*/,_______  /*|                                   |*/,_______  /*|*/,_______          /*|*/,_______  /*|*/,_______  /*|*/,KX_DGRE  /*|*/,_______    /*|
         * |--------------+--------------+--------------+--------------+----------------------+--------------|                                   |--------------+----------------------+--------------+--------------+--------------+----------------|
         * |*/,_______  /*|*/,_______  /*|*/,_______  /*|*/,KX_EGRV  /*|*/,_______          /*|*/,_______  /*|                                   |*/,_______  /*|*/,KX_UGRV          /*|*/,KX_IGRV  /*|*/,KX_OGRV  /*|*/,_______  /*|*/,_______    /*|
         * |--------------+--------------+--------------+--------------+----------------------+--------------|                                   |--------------+----------------------+--------------+--------------+--------------+----------------|
         * |*/,_______  /*|*/,KX_AGRV  /*|*/,_______  /*|*/,_______  /*|*/,_______          /*|*/,_______  /*|---------------.    ,--------------|*/,KX_LEFT  /*|*/,KX_DOWN          /*|*/,KX_UP    /*|*/,KX_RIGHT /*|*/,_______  /*|*/,KC_QUOT    /*|
         * |--------------+--------------+--------------+--------------+----------------------+--------------|               |    |              |--------------+----------------------+--------------+--------------+--------------+----------------|
         * |*/,_______  /*|*/,_______  /*|*/,_______  /*|*/,_______  /*|*/,_______          /*|*/,_______  /*|*/,OSL(_SYMB)/*|    |*/,TO(_SYMB)/*|*/,_______  /*|*/,_______          /*|*/,KX_LDAQM /*|*/,KX_RDAQM /*|*/,_______  /*|*/,_______    /*|
         * `-------------------------------------------------------------------------------------------------/---------------/     \--------------\--------------------------------------------------------------------------------------------------'
         *                                                 |*/,TO(_QWERTY)/*|*/,_______  /*|*/,_______  /*| /*/,_______   /*/       \*/,_______ /*\*/,LT(_MOVE, KC_ENT) /*|*/,_______  /*|*/,_______  /*|
         *                                                 `---------------------------------------------------------------'         `------------------------------------------------------------------'
         */
    ),
    [_FUNC] = LAYOUT(
    ...
    [_CANARY] = LAYOUT(
         ...
         * |*/KC_ESC    /*|*/,KC_1     /*|*/,KC_2     /*|*/,KC_3     /*|*/,KC_4             /*|*/,KC_5     /*|                                   |*/,KC_6     /*|*/,KC_7             /*|*/,KC_8     /*|*/,KC_9     /*|*/,KC_0     /*|*/,KC_EQL   /*|
         * |--------------+--------------+--------------+--------------+----------------------+--------------|                                   |--------------+----------------------+--------------+--------------+--------------+--------------|
         * |*/,KC_TAB   /*|*/,KC_W     /*|*/,KC_L     /*|*/,KC_Y     /*|*/,LT(_ACCENT, KC_P)/*|*/,KC_B     /*|                                   |*/,KC_Z     /*|*/,LT(_ACCENT, KC_F)/*|*/,KC_O     /*|*/,KC_U     /*|*/,KC_SCLN  /*|*/,KC_MINS  /*|
         * |--------------+--------------+--------------+--------------+----------------------+--------------|                                   |--------------+----------------------+--------------+--------------+--------------+--------------|
         * |*/,KC_LSFT  /*|*/,KC_C     /*|*/,KC_R     /*|*/,KC_S     /*|*/,KC_T             /*|*/,KC_G     /*|---------------.    ,--------------|*/,KC_M     /*|*/,KC_N             /*|*/,KC_E     /*|*/,KC_I     /*|*/,KC_A     /*|*/,KC_QUOT  /*|
         * |--------------+--------------+--------------+--------------+----------------------+--------------|               |    |              |--------------+----------------------+--------------+--------------+--------------+--------------|
         * |*/,KC_LALT  /*|*/,KC_Q     /*|*/,KC_J     /*|*/,KC_V     /*|*/,KC_D             /*|*/,KC_K     /*|*/,OSL(_SYMB)/*|    |*/,TO(_SYMB)/*|*/,KC_X     /*|*/,KC_H             /*|*/,KC_COMM  /*|*/,KC_DOT   /*|*/,KC_SLSH  /*|*/,KC_RCTL  /*|
         * `-------------------------------------------------------------------------------------------------/-------------- /     \-------------\-------------------------------------------------------------------------------------------------'
         *                                                 |*/,TO(_QWERTY)/*|*/,KC_LGUI  /*|*/,KC_LCTL  /*| /*/,KC_SPC    /*/       \*/,KC_RSFT /*\*/,LT(_MOVE, KC_ENT) /*|*/,KC_BSPC  /*|*/,KC_DEL   /*|
         *                                                 `---------------------------------------------------------------'         `------------------------------------------------------------------'
         */
